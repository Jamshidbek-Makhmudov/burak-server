...
class OrderService {
    ...
    async createOrder(member, input) {
        ...
        try {
            ...
            throw new Errors_1.default(Errors_2.HttpmCode.BAD_REQUEST, Errors_1.Message.CREATE_FAILED);
        }
    }
    ...
    async getMyOrders(member, inquiry) {
        ...
        const result = await this.orderModel.aggregate([
            ...
            .exec();
        if (!result)
            throw new Errors_1.default(Errors_2.HttpmCode.NOT_FOUND, Errors_1.Message.NO_DATA_FAUND);
        return result;
    }
    async updateOrder(member, input) {
        ...
        if (!result)
            throw new Errors_1.default(Errors_2.HttpmCode.NOT_MODIFIED, Errors_1.Message.UPDATE_FAILED);
